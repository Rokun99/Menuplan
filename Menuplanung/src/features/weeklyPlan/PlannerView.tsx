...
export const PlannerView: React.FC<PlannerViewProps> = ({ currentDate, handleDateChange, setView, recipes, recipeMap, allergenMap, portionEstimates }) => {
    const { menuData, handleUpdateData } = useWeekPlan(currentDate);
    ...
    const handleApplySelection = (selection: string) => {
        ...
        handleUpdateData(path, selection);
